      ...
      <div className="flex flex-row gap-4">
        ...
        <div className='w-full'>
          <div className='flex justify-between'>
            <p className="font-bold self-center">{data?.name.length > 10 ? data?.name.substring(0, 10) + "..." : data?.name}</p> {data?.type === 'live' && (<img className='inline ml-2' src="/asset/icon/ic_live_text.png" />)}
          </div>
